...
def main(args=None):
    ...
    # META DATA
    pretrained_pth = '/data1/whl/unify/output/colon_lap/xdecoder_focalt_lang.yaml_conf~/run_13/00151740/default/model_state_dict.pt'
    output_root = './output/colon_lap/run_13_00151740/PICCOLO/'
    os.makedirs(output_root,exist_ok=True)
    image_pth = '/data1/whl/Datasets/xdecoder_data/PICCOLO/test'
...
# CUDA_VISIBLE_DEVICES=1 python infer_piccolo.py evaluate --conf_files configs/xdecoder/xdecoder_focall_my1_colon_lap.yaml