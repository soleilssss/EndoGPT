...
def get_class_names(name):
    if name is None:
    ...
    elif 'sun_seg' in name and 'cls' not in name:
        return MYPOLYP_SEM_CLASSES + ["background"]
    elif 'sun' in name and 'seg' not in name:
        ...
        return ["background"]
    elif 'mypolyp_sem_seg' in name:
        return MYPOLYP_SEM_CLASSES + ["background"]
    elif 'mypolyp_inst_seg' in name:
        return MYPOLYP_INSTANCE_CLASSES + ["background"]
    elif 'giana' in name:
        return MYPOLYP_SEM_CLASSES + ["background"]
    elif 'piccolo' in name:
        return MYPOLYP_SEM_CLASSES + ["background"]
    elif 'polyp_all' in name:
        return MYPOLYP_SEM_CLASSES + ["background"]
    elif 'cholecseg8k_2' in name:
        return CHOLECSEG8K_2_CLASSES + ["background"]
    elif 'cholecseg8k' in name:
        return CHOLECSEG8K_TEST_CLASSES + ["background"]
    elif 'colon_lap' in name:
        return CHOLECSEG8K_CLASSES + ["background"]
    elif 'polyp_cls_2' in name:
        return MYPOLYP_CLS_2_CLASSES + ["background"]
    elif 'polyp_cls' in name:
        return MYPOLYP_CLS_CLASSES + ["background"]
    elif 'fetreg' in name:
        return FETREG_CLASSES + ["background"]   
    elif 'sinus' in name:
        return SINUS_CLASSES + ["background"]   
    elif 'fewshot_2' in name:
        return FEWSHOT_2_CLASSES + ["background"]  
    elif 'fewshot' in name:
        return FEWSHOT_CLASSES + ["background"]  
    elif 'sun_seg_cls' in name:
        return SUN_SEG_CLASSES + ["background"]  
    elif 'ldpolypvideo' in name:
        return MYPOLYP_SEM_CLASSES + ["background"]
    elif 'polypset' in name:
        return MYPOLYP_SEM_CLASSES + ["background"]
    elif 'm2caiseg' in name:
        return M2CAISEG_CLASSES + ["background"]
    elif 'c20250912' in name:
        return C20250912_CLASSES + ["background"]
    else:
