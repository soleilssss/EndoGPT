...
from .polyp_instseg_dataset_mapper import PolypInstDatasetMapper
from .mask_former_semantic_dataset_mapper_multiclass import MaskFormerSemanticDatasetMapperMultiClass
from .polyp_cls_dataset_mapper import PolypCLSDatasetMapper