...
__all__ = ["MaskFormerSemanticDatasetMapperMultiClass"]

class MaskFormerSemanticDatasetMapperMultiClass:
    """
    ...
    def __call__(self, dataset_dict):
        ...
        if "sem_seg_file_name" in dataset_dict:
            ...
            sem_seg_gt =  np.asarray(Image.open(dataset_dict.pop("sem_seg_file_name"))
        ...
        if sem_seg_gt is not None:
            ...
            # masks.append(sem_seg_gt == self.ignore_label)
