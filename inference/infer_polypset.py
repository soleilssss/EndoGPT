...
def main(args=None):
    ...
    # META DATA
    pretrained_pth = '/data1/whl/unify/output/PolypSet/xdecoder_focalt_lang.yaml_conf~/run_1/00082560/default/model_state_dict.pt'
    ...
    output_root = '/data1/whl/unify/evaluate/output/PolypSet/run_1_00082560/'
    os.makedirs(output_root,exist_ok=True)
    image_pth = '/data1/whl/Datasets/xdecoder_data/PolypSet/test'
...
# CUDA_VISIBLE_DEVICES=3 python inference/infer_polypset.py evaluate --conf_files configs/xdecoder/xdecoder_focall_my1_polypset.yaml