...
def hook_switcher(model, name):
    mappings = {}
    if name in ['cityscapes_fine_sem_seg_val', 'scannet_21_val_seg', 'scannet_38_val_seg', 'scannet_41_val_seg', 'sunrgbd_37_val_seg', 'context_59_val_seg', 'context_459_val_seg', 'voc_2012_val_seg', 'bdd10k_val_sem_seg', 
                'ade20k_full_sem_seg_val','mypolyp_sem_seg_val','giana_test','piccolo_test','colon_lap_test','cholecseg8k_test','polyp_cls_test','polyp_cls_2_test','fetreg_test','sinus_test','sun_seg_cls_test_hard',
                'sun_seg_cls_test_easy','ldpolypvideo_test','polypset_test','m2caiseg_test','m2caiseg_test_fewshot','cholecseg8k_2_test','sun_seg_train','c20250912_test']:
        mappings = {'SEMANTIC_ON': True, 'INSTANCE_ON': False, 'PANOPTIC_ON': False}
    elif name in ['cityscapes_fine_instance_seg_val','mypolyp_inst_seg_val'] or 'seginw' in name:
