...
CHOLECSEG8K_CLASSES=["Abdominal Wall","Liver","Gastrointestinal Tract","Fat","Grasper","L-hook Electrocautery","Gallbladder","back"]
def register_mypolyp_semseg(root):

    root = os.path.join(root, "CholecSeg8k")
